...
<header class="navbar-masthead banner navbar navbar-inverse navbar-static-top visible-md visible-lg" role="banner">
  <div class="container">
    ...
    <div class="pull-right" style="width: 320px; padding-top:20px;">
      <p>
        <a class="btn btn-xs btn-link" href="http://www.spokanelibrary.org"><i class="glyphicon glyphicon-home text-success"></i> <strong>Spokane Public Library Website</strong></a>
