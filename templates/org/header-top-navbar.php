...
<header class="navbar-masthead banner navbar navbar-inverse navbar-static-top visible-md visible-lg" role="banner">
  <div class="container">
    ...
    <div class="pull-right" style="width: 320px; padding-top:20px;">
      <p>
        <a class="btn btn-xs btn-primary btn-block" href="http://www.spokanelibrary.org"><img src="/assets/img/spl-touch-inverse.png" style="height:25px; width:20px;"> <br>Spokane Public Library Website</a>
