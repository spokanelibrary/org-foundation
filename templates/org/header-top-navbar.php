...
<header class="navbar-masthead banner navbar navbar-inverse navbar-static-top visible-md visible-lg" role="banner">
  <div class="container">
    ...
    <div class="pull-right" style="width: 320px; padding-top:20px;">
      <p>
        <a class="btn btn-xs btn-block btn-default" href="http://www.spokanelibrary.org"><span class="text-primary"><i class="glyphicon glyphicon-home"></i> Spokane Public Library Website</span></a>
      </p>
      <p>
        <a class="btn btn-xs btn-block btn-default" href="http://www.facebook.com/spokanelibrary"><span class="text-primary"><i class="glyphicon glyphicon-thumbs-up"></i> Spokane Public Library on Facebook</span></a>
      </p>
    </div>
  </div>
</header><!-- /.navbar -->
  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand hidden-md hidden-lg" href="<?php echo home_url(); ?>/">
        <span class="logotype hidden-xs">SPL Foundation</span>
